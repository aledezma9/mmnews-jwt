...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    jwtMmnewsAuthUserSubject.add(
      JwtMmnewsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<JwtMmnewsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  JwtMmnewsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = JwtMmnewsAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    jwtMmnewsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
